"""Inference script for BestTN-Mammo4 (ENSEMBLE_E3_E7_SOTA).

Reference Performance: N=132, Macro-F1 = 0.7384, QWK = 0.7665, Accuracy = 0.7273
"""
...
def main():
    parser = argparse.ArgumentParser(description="BestTN-Mammo4 SOTA Inference")
    ...
    if y_true is not None:
        ...
        print("\n==================================================")
        print("BestTN-Mammo4 INFERENCE RESULTS (SOTA)")
        print("==================================================")
