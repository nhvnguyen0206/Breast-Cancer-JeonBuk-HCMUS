...
from tn_mammo.training.engine import _write_predictions, evaluate


def run_eval(
    checkpoint_path: Path, manifest_path: Path, output_dir: Path | None = None
) -> dict:
    ...
    transform_options = data_config.get("preprocessing")
    ...
    metrics, predictions = evaluate(
        model, loader, device, amp=device.type == "cuda",
